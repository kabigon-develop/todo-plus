...
export function getDialogContentClass() {
  return 'fixed bottom-0 left-1/2 z-50 w-[95vw] max-w-lg -translate-x-1/2 rounded-t-xl border-t border-border bg-surface-elevated p-6 shadow-lg ring-offset-surface-card data-[state=open]:animate-in data-[state=open]:slide-in-from-bottom data-[state=open]:duration-200 data-[state=open]:ease-out data-[state=closed]:animate-out data-[state=closed]:slide-out-to-bottom data-[state=closed]:duration-150';
}
